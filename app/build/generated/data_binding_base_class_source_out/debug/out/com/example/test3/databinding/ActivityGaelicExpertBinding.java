...
public final class ActivityGaelicExpertBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGaelicExpertBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout burpees,
      ...
      @NonNull Toolbar toolBar, @NonNull LinearLayout tricepdips) {
  ...
  @NonNull
  public static ActivityGaelicExpertBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGaelicExpertBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_gaelic_expert, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGaelicExpertBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGaelicExpertBinding((LinearLayout) rootView, burpees, button, buttonTwo,
          checkBox, checkBox2, checkBox3, checkBox4, mountainclimbers, squats, toolBar, tricepdips);
    }
