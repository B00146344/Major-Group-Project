...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull RelativeLayout rootView, @NonNull Button buttonRegister,
      ...
      @NonNull EditText editTextPassword, @NonNull TextView textViewCreateAccount,
      @NonNull TextView textViewLoginLink) {
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegisterBinding((RelativeLayout) rootView, buttonRegister, editTextEmail,
          editTextName, editTextPassword, textViewCreateAccount, textViewLoginLink);
    }
