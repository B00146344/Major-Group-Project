...
public final class ActivityBasketballExpertBinding implements ViewBinding {
  ...
  private ActivityBasketballExpertBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull LinearLayout hollowbodyholds, @NonNull LinearLayout lsithold,
      @NonNull LinearLayout singlearmpushup, @NonNull TextView textView, @NonNull Toolbar toolBar) {
  ...
  public static ActivityBasketballExpertBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBasketballExpertBinding((LinearLayout) rootView, burpees, button, checkBox,
          checkBox2, checkBox3, checkBox4, hollowbodyholds, lsithold, singlearmpushup, textView,
          toolBar);
    }
