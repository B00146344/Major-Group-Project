...
public final class ActivitySquatsBinding implements ViewBinding {
  ...
  private ActivitySquatsBinding(@NonNull RelativeLayout rootView, @NonNull Button startbutton,
      @NonNull Button time) {
  ...
  public static ActivitySquatsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySquatsBinding((RelativeLayout) rootView, startbutton, time);
    }
