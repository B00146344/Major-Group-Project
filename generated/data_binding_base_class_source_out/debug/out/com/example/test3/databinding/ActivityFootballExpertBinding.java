...
public final class ActivityFootballExpertBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityFootballExpertBinding(@NonNull LinearLayout rootView,
      @NonNull LinearLayout burpees, @NonNull Button button, @NonNull CheckBox checkBox,
      @NonNull CheckBox checkBox2, @NonNull CheckBox checkBox3, @NonNull CheckBox checkBox4,
      @NonNull LinearLayout mountainclimbers, @NonNull LinearLayout squats,
      @NonNull TextView textView, @NonNull Toolbar toolBar, @NonNull LinearLayout tricepdips) {
  ...
  @NonNull
  public static ActivityFootballExpertBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFootballExpertBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_football_expert, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFootballExpertBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFootballExpertBinding((LinearLayout) rootView, burpees, button, checkBox,
          checkBox2, checkBox3, checkBox4, mountainclimbers, squats, textView, toolBar, tricepdips);
    }
