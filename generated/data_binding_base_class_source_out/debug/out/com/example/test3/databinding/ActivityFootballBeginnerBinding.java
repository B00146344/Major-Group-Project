...
public final class ActivityFootballBeginnerBinding implements ViewBinding {
  ...
  private ActivityFootballBeginnerBinding(@NonNull LinearLayout rootView, @NonNull Button button,
      ...
      @NonNull CheckBox checkBox4, @NonNull LinearLayout highknee, @NonNull LinearLayout lunges,
      @NonNull LinearLayout squatjump, @NonNull LinearLayout starjumps, @NonNull TextView textView,
  ...
  public static ActivityFootballBeginnerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFootballBeginnerBinding((LinearLayout) rootView, button, checkBox,
          checkBox2, checkBox3, checkBox4, highknee, lunges, squatjump, starjumps, textView,
          toolBar);
    }
